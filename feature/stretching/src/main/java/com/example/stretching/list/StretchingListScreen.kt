            ...
            Surface(
                ...
                Column(
                    ...
                    StretchingList("목 굽히기", "목의 양 앞, 옆 근육들을 풀어주는 동작으로 목 통증 완화에 도움을 줘요",
                        image = R.drawable.image_neckdown,
                        modifier = Modifier.clickable(
                            onClick = {
                                Toast.makeText(localContext, "클릭", Toast.LENGTH_SHORT).show()
                    ...
                    StretchingList("어깨 돌리기", "손목 터널 증후군 예방과 손목 유연성 강화에 도움을 줘요",
                        image = R.drawable.image_shoulder,
                        modifier = Modifier.clickable {
                        Toast.makeText(localContext, "클릭", Toast.LENGTH_SHORT).show()
                    ...
                    StretchingList("팔 펴서 당기기", "내용4",
                        image = R.drawable.image_arm,
                        modifier = Modifier.clickable {
                        Toast.makeText(localContext, "클릭", Toast.LENGTH_SHORT).show()
                        navigateToArm()
                    })
                    Spacer(modifier = Modifier . height (12.dp))
                    StretchingList("손목 스트레칭", "손목 터널 증후군 예방과 손목 유연성 강화에 도움을 줘요",
                        image = R.drawable.image_wrist,
                        modifier = Modifier.clickable {
                        Toast.makeText(localContext, "클릭", Toast.LENGTH_SHORT).show()
                        navigateToWrist()
                    })
...
fun StretchingListPreview() {
    StretchingList("제목","내용", R.drawable.image_neckdown, modifier = Modifier)
}
